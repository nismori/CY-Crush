...
void main()
{
    ...
    int tab2[TWO], length, width, sign, roundNmb, totalTime = 0, score = 0;; // longueur, largeur, nombre de symboles, temps de jeu, nombre de tous, score;
    char** tab;
    ...
    saveHighscores(score,totalTime); //on sauvegarde le score du joueur
    printf("\n");
    printf("HIGHSCORES : \n\n"); //puis on affiche les meilleurs scores enregistrés
    loadHighscore();
